<?php
    $app->post('/joborders/{id}/ablehnen', function($request, $response, $args) {
        try{
    
            $db = getDB();
            $sth = $db->prepare("INSERT INTO `joborders_abgelehnt` (`ressources_id`, `joborders_id`) VALUES (:ressources_id, :joborders_id)");
