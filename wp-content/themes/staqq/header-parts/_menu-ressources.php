...
<li class="menu-item--casting <?php echo currentMenuItem('/app/castings/'); ?>">
	<a href="/app/castings/">
...
<li class="<?php echo currentMenuItem('/app/stammdaten/'); ?>">
	<a href="/app/stammdaten/">
		<i class="icon icon--menu icon--matching-kriterien"></i>
		<div class="two-lines">Stammdaten &<br>Suchkriterien</div>
	</a>
</li>
