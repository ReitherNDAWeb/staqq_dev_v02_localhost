...
/**
 * @XmlType(name="Price", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Price extends Customweb_Mpay24_Stubs_PriceType {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Price();
		return $i;
	}
	/**
