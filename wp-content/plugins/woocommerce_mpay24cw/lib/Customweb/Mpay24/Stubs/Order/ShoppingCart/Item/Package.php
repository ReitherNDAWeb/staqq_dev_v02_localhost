...
/**
 * @XmlType(name="Package", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Package extends Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Package();
		return $i;
	}
	/**
