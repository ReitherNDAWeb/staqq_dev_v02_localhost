...
/**
 * @XmlType(name="SubTotal", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_SubTotal extends Customweb_Mpay24_Stubs_PriceType {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_SubTotal();
		return $i;
	}
	/**
