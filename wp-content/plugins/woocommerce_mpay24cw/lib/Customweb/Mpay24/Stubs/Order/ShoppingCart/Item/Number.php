 ...
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Number extends Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Number();
		return $i;
	}
	/**
