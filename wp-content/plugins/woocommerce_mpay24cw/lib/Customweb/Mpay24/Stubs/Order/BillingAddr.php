...
/**
 * @XmlType(name="BillingAddr", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_BillingAddr extends Customweb_Mpay24_Stubs_AddressType {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_BillingAddr();
		return $i;
	}
	/**
