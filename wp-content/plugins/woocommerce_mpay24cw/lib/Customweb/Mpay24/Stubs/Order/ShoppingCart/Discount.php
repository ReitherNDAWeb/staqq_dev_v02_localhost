...
/**
 * @XmlType(name="Discount", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_Discount extends Customweb_Mpay24_Stubs_PriceType {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_Discount();
		return $i;
	}
	/**
