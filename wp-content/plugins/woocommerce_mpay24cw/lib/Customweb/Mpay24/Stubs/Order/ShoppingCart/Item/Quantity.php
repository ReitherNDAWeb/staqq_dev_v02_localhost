...
/**
 * @XmlType(name="Quantity", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Quantity extends Customweb_Mpay24_Stubs_Org_W3_XMLSchema_Integer {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_Item_Quantity();
		return $i;
	}
	/**
