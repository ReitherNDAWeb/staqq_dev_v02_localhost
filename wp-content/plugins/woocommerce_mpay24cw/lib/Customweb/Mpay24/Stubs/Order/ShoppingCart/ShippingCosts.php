...
/**
 * @XmlType(name="ShippingCosts", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Order_ShoppingCart_ShippingCosts extends Customweb_Mpay24_Stubs_PriceType {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Order_ShoppingCart_ShippingCosts();
		return $i;
	}
	/**
