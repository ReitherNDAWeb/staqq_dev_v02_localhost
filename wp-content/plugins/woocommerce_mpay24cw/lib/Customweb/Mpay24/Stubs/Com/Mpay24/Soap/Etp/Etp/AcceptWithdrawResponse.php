 ...
 */ 
class Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_AcceptWithdrawResponse {
	/**
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_AcceptWithdrawResponse();
		return $i;
	}
	/**
