...
/**
 * @XmlType(name="TransactionConfirmationResponse", namespace="https://www.mpay24.com/soap/etp/1.5/ETP.wsdl")
 */ 
class Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionConfirmationResponse {
	/**
	...
	/**
	 * @XmlList(name="confirmation", type='Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Confirmation')
	 * @var Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Confirmation[]
	 */
	private $confirmation;
	
	public function __construct() {
		$this->confirmation = new ArrayObject();
	}
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionConfirmationResponse();
		return $i;
	}
	/**
	 ...
	 * 
	 * @param Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Confirmation $confirmation
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionConfirmationResponse
	 */
	public function setConfirmation($confirmation){
		if (is_array($confirmation)) {
			$confirmation = new ArrayObject($confirmation);
		}
		if ($confirmation instanceof ArrayObject) {
			$this->confirmation = $confirmation;
		}
		else {
			throw new BadMethodCallException("Type of argument confirmation must be ArrayObject.");
		}
		return $this;
	}
	
	/**
	 * Adds the given $item to the list of items of confirmation.
	 * 
	 * @param Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Confirmation $item
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionConfirmationResponse
	 */
	public function addConfirmation(Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Confirmation $item) {
		if (!($this->confirmation instanceof ArrayObject)) {
			$this->confirmation = new ArrayObject();
		}
