...
/**
 * @XmlType(name="ManualClearResponse", namespace="https://www.mpay24.com/soap/etp/1.5/ETP.wsdl")
 */ 
class Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_ManualClearResponse {
	/**
	...
	/**
	 * @XmlList(name="transaction", type='Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Transaction')
	 * @var Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Transaction[]
	 */
	private $transaction;
	
	public function __construct() {
		$this->transaction = new ArrayObject();
	}
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_ManualClearResponse();
		return $i;
	}
	/**
	...
	public function setTransaction($transaction){
		if (is_array($transaction)) {
			$transaction = new ArrayObject($transaction);
		}
		if ($transaction instanceof ArrayObject) {
			$this->transaction = $transaction;
		}
		else {
			throw new BadMethodCallException("Type of argument transaction must be ArrayObject.");
		}
		return $this;
	}
	
	/**
	 * Adds the given $item to the list of items of transaction.
	 * 
	 * @param Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Transaction $item
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_ManualClearResponse
	 */
	public function addTransaction(Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_Transaction $item) {
		if (!($this->transaction instanceof ArrayObject)) {
			$this->transaction = new ArrayObject();
		}
