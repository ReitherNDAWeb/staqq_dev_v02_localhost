...
/**
 * @XmlType(name="CreatePaymentTokenResponse", namespace="https://www.mpay24.com/soap/etp/1.5/ETP.wsdl")
 */ 
class Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_CreatePaymentTokenResponse {
	/**
	...
	/**
	 * @XmlNillable
	 * @XmlValue(name="apiKey", simpleType=@XmlSimpleTypeDefinition(typeName='string', typeNamespace='http://www.w3.org/2001/XMLSchema', type='Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String'))
	 * @var string
	 */
	private $apiKey;
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_CreatePaymentTokenResponse();
		return $i;
	}
	/**
	...
	public function setToken($token){
		...
		else if (is_object($token) && get_class($token) == "Customweb_Xml_Nil") {
			$this->token = $token;
		}
		else {
	...
	/**
	 * Returns the value for the property apiKey.
	 * 
	 * @return Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String
	 */
	...
	/**
	 * Sets the value for the property apiKey.
	 * 
	 * @param string $apiKey
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_CreatePaymentTokenResponse
	 */
	public function setApiKey($apiKey){
		if ($apiKey instanceof Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String) {
			$this->apiKey = $apiKey;
		}
		else if (is_object($apiKey) && get_class($apiKey) == "Customweb_Xml_Nil") {
			$this->apiKey = $apiKey;
		}
		else {
			$this->apiKey = Customweb_Mpay24_Stubs_Org_W3_XMLSchema_String::_()->set($apiKey);
		}
		return $this;
	}
	...
	public function setLocation($location){
		...
		else if (is_object($location) && get_class($location) == "Customweb_Xml_Nil") {
			$this->location = $location;
		}
		else {
