...
/**
 * @XmlType(name="TransactionHistoryResponse", namespace="https://www.mpay24.com/soap/etp/1.5/ETP.wsdl")
 */ 
class Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionHistoryResponse {
	/**
	...
	/**
	 * @XmlList(name="historyEntry", type='Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_HistoryEntry')
	 * @var Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_HistoryEntry[]
	 */
	private $historyEntry;
	
	public function __construct() {
		$this->historyEntry = new ArrayObject();
	}
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionHistoryResponse();
		return $i;
	}
	/**
	...
	/**
	 * Returns the value for the property historyEntry.
	 * 
	...
	/**
	 * Sets the value for the property historyEntry.
	 * 
	 * @param Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_HistoryEntry $historyEntry
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionHistoryResponse
	 */
	public function setHistoryEntry($historyEntry){
		if (is_array($historyEntry)) {
			$historyEntry = new ArrayObject($historyEntry);
		}
		if ($historyEntry instanceof ArrayObject) {
			$this->historyEntry = $historyEntry;
		}
		else {
			throw new BadMethodCallException("Type of argument historyEntry must be ArrayObject.");
		}
		return $this;
	}
	
	/**
	 * Adds the given $item to the list of items of historyEntry.
	 * 
	 * @param Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_HistoryEntry $item
	 * @return Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_TransactionHistoryResponse
	 */
	public function addHistoryEntry(Customweb_Mpay24_Stubs_Com_Mpay24_Soap_Etp_Etp_HistoryEntry $item) {
		if (!($this->historyEntry instanceof ArrayObject)) {
			$this->historyEntry = new ArrayObject();
		}
