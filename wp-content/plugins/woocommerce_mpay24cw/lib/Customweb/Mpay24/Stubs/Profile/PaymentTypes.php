...
require_once 'Customweb/Mpay24/Stubs/Profile/PaymentTypes/Payment.php';
require_once 'Customweb/Mpay24/Stubs/Org/W3/XMLSchema/Boolean.php';
/**
 * @XmlType(name="PaymentTypes", namespace="")
 */ 
class Customweb_Mpay24_Stubs_Profile_PaymentTypes {
	/**
	 * @XmlList(name="Payment", type='Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment')
	 * @var Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment[]
	 */
	private $payment;
	...
	public static function _() {
		$i = new Customweb_Mpay24_Stubs_Profile_PaymentTypes();
		return $i;
	}
	/**
	 * Returns the value for the property payment.
	 * 
	 * @return Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment[]
	 */
	 ...
	 * 
	 * @param Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment $payment
	 * @return Customweb_Mpay24_Stubs_Profile_PaymentTypes
	 */
	 ...
	 * 
	 * @param Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment $item
	 * @return Customweb_Mpay24_Stubs_Profile_PaymentTypes
	 */
	public function addPayment(Customweb_Mpay24_Stubs_Profile_PaymentTypes_Payment $item) {
