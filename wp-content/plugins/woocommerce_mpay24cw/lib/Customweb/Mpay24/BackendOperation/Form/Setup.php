 ...
 * @BackendForm
 */
class Customweb_Mpay24_BackendOperation_Form_Setup extends Customweb_Payment_BackendOperation_Form_Abstract {
	...
	private function getSteps(){
		return array(
			Customweb_I18n_Translation::__("Enter the Merchant ID, Username and Password that you received from MPAY24 in the main module."),
			Customweb_I18n_Translation::__("You do have the option to style the payment pages. In the payment page styling section you are able to define your CSS that will be applied to the payment pages."),
			Customweb_I18n_Translation::__("Activate the payment method that you want to process transactions with.") 
		);
	}
