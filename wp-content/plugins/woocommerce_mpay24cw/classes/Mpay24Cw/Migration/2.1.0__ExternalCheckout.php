...
class Mpay24Cw_Migration_2_1_0 implements Customweb_Database_Migration_IScript{

	public function execute(Customweb_Database_IDriver $driver) {
		global $wpdb;
		
		$driver->query("CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "woocommerce_mpay24cw_ecc` (
