...
class Mpay24Cw_Migration_2_4_0 implements Customweb_Database_Migration_IScript {
	...
	public function execute(Customweb_Database_IDriver $driver){
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "woocommerce_mpay24cw_documents` (
