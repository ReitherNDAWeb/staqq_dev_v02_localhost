...
class Mpay24Cw_Migration_2_1_1 implements Customweb_Database_Migration_IScript{

	public function execute(Customweb_Database_IDriver $driver) {
		global $wpdb;
		
		$tableName = $wpdb->prefix . 'woocommerce_mpay24cw_external_checkout_contexts';
		$tableNameNew = $wpdb->prefix . 'woocommerce_mpay24cw_ecc';
