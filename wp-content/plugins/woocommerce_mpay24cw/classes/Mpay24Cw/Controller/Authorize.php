 ...
 *
 */
class Mpay24Cw_Controller_Authorize extends Mpay24Cw_Controller_Abstract {
	...
	public function indexAction() {
		...
		Mpay24Cw_Util::getTransactionHandler()->persistTransactionObject($transactionObject);
