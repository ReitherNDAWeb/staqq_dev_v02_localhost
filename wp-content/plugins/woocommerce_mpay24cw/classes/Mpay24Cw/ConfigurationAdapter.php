 ...
 *
 */
require_once 'Mpay24Cw/AbstractConfigurationAdapter.php';


/**
 * @Bean
 */
class Mpay24Cw_ConfigurationAdapter extends Mpay24Cw_AbstractConfigurationAdapter {

	public static function isReviewFormInputActive(){
		$value = get_option('woocommerce_mpay24cw_review_input_form', 'active');
		if ($value == 'active') {
			return true;
		}
		else {
	...
	public static function getExternalCheckoutPlacement(){
		return get_option('woocommerce_mpay24cw_external_checkout_placement', 'both');
	}
	
	public static function getExternalCheckoutAccountCreation(){
		return get_option('woocommerce_mpay24cw_external_checkout_account_creation', 'skip_selection');
	}
	
	public static function getOrderNumberIdentifier(){
		return get_option('woocommerce_mpay24cw_order_identifier', 'ordernumber');
	}
