...
require_once 'Mpay24Cw/Database/Statement.php';

final class Mpay24Cw_Database_Driver extends Customweb_Database_Driver_AbstractDriver {
	...
	public function query($query){
		$statement = new Mpay24Cw_Database_Statement($query, $this);
		return $statement;
	}
