...
class Mpay24Cw_LayoutRenderer implements Customweb_Mvc_Layout_IRenderer{
	...
	public function render(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		if(!empty($title)) {
			$GLOBALS['woo_mpay24cwTitle'] = $title;
		}
		...
		$GLOBALS['woo_mpay24cwCSS'] = $cssString;
		...
		$GLOBALS['woo_mpay24cwJS'] = $jsString;
		$GLOBALS['woo_mpay24cwContent'] = $context->getMainContent();
