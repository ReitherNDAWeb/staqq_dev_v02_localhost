...
class Mpay24Cw_Dispatcher
{
	...
	public function dispatch() {
		try {
			$request = Mpay24Cw_ContextRequest::getInstance();
	...
	private function getControllerInstance() {
		...
		$expectedClassName = 'Mpay24Cw_Controller_' . Customweb_Core_Util_String::ucFirst($this->controllerName);
		$effectiveClass = null;
