...
class Mpay24Cw_Eps extends Mpay24Cw_PaymentMethod
{
	...
	protected function getMethodSettings(){
		return array(
			'epsbrand' => array(
				'title' => __("EPS Brand", 'woocommerce_mpay24cw'),
 				'default' => 'EPS',
 				'description' => __("The EPS payment type supports two so called brands. The brand EPS is used for EPS online-banking transactions with Austrian banks. The brand INTERNATIONAL is used for interoperability of EPS online-banking with Giropay online-banking and allows to use Austrian banks as well as German banks. The interoperability is is only available with an additional EPS agreement. Please contact mPAY24 for further information.", 'woocommerce_mpay24cw'),
 				'cwType' => 'select',
 				'type' => 'select',
 				'options' => array(
					'EPS' => __("EPS", 'woocommerce_mpay24cw'),
 					'INTERNATIONAL' => __("INTERNATIONAL", 'woocommerce_mpay24cw'),
 				),
 			),
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_mpay24cw_eps_icon', 
			Mpay24Cw_Util::getResourcesUrl('icons/eps.png')
		);
		parent::__construct();
	}
