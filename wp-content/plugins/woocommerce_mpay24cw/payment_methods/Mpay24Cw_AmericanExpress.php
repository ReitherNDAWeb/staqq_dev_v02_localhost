...
class Mpay24Cw_AmericanExpress extends Mpay24Cw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_mpay24cw_americanexpress_icon', 
			Mpay24Cw_Util::getResourcesUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
