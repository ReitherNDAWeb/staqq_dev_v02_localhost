...
class Mpay24Cw_Paybox extends Mpay24Cw_PaymentMethod
{
	public $machineName = 'paybox';
	public $admin_title = 'Paybox Mobile Phone Payment';
	public $title = 'Paybox Mobile Phone Payment';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_mpay24cw_paybox_icon', 
			Mpay24Cw_Util::getResourcesUrl('icons/paybox.png')
		);
		parent::__construct();
	}
