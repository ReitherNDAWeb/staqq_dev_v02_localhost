...
class Mpay24Cw_SafetyPay extends Mpay24Cw_PaymentMethod
{
	public $machineName = 'safetypay';
	public $admin_title = 'SafetyPay';
	public $title = 'SafetyPay';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_mpay24cw_safetypay_icon', 
			Mpay24Cw_Util::getResourcesUrl('icons/safetypay.png')
		);
		parent::__construct();
	}
